Корзина, с возможностью добавления и удаления товаров, есть возможность изменять количество заказываемых товаров, также есть каталог товаров, приложение написано на TypeScript.
